...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        Value *GEP=builder.CreateGEP(gvar->getValueType(),gvar,ArrayRef<Value*>(indexList, 2),"arrayIdx");
                        LoadInst *loadElement=builder.CreateLoad(gvar->getValueType(),GEP,false);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        bool runOnModule(Module &M, bool is_flag) {
                if(!is_flag){
                        return false;
                }
...
llvm::PreservedAnalyses llvm::StringObfuscationPass::run(llvm::Module &M, llvm::ModuleAnalysisManager &AM)
{
        if (runOnModule(M, flag))
                return PreservedAnalyses::all();

        return PreservedAnalyses::none();
}

StringObfuscationPass* llvm::createStringObfuscation(bool flag) {
