...
Function *StringEncryptionPass::buildDecryptFunction(
    ...
    PlainString->addAttr(Attribute::get(PlainString->getContext(), Attribute::ReadOnly));
    Data->setName("data");
    Data->addAttr(Attribute::get(Data->getContext(), Attribute::ReadOnly));
...
StringEncryptionPass::buildInitFunction(Module *M,
    ...
    thiz->setName("this");
    thiz->addAttr(Attribute::get(thiz->getContext(), Attribute::ReadOnly));
